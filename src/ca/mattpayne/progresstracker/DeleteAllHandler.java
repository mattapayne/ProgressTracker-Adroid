...
public class DeleteAllHandler extends AsyncTask<String, Void, Void> {

	private Activity _activity;

	public DeleteAllHandler(Activity activity) {
		_activity = activity;
	}
	...
	protected void onPostExecute(Void result) {
		...
		String message = _activity
				.getString(R.string.deleted_all_checkins_message_text);
		String title = _activity
				.getString(R.string.deleted_all_checkins_dialog_title);
